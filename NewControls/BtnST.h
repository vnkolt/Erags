...
public:
  ...
  void  SetGradientParent(BOOL fGradientParent, BOOL bRepaint = FALSE);
	DWORD SetBk(CDC* pDC);
...
protected:
  ...
  BOOL		m_bGradientParent;	// TRUE if Parent Window has gradient background?
