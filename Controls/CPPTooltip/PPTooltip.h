...
// This info structure
/************************************** : by VK at 16.07.2005 18:26:35 **\
typedef struct tagPPTT_INFO
{
...
protected:
	...
	PPTT_INFO m_tiDisplayed; //Info about displayed tooltip
	...
	PPTT_INFO m_tiNextTool; //Info about next tooltip
	...
	//Initialize tools
	typedef std::vector<PPTT_INFO>	arHotArea; // array of Tips rectangular spots
...
public:
	...
	void AddTool(CWnd * pWnd, PPTT_INFO & ti);
	...
	void ShowHelpTooltip (LPPOINT pt, PPTT_INFO & ti);
	void HideTooltip();
...
protected:
	...
	void SetNewTooltip(HWND hWnd, const PPTT_INFO & ti, BOOL bDisplayWithDelay = TRUE, TooltipType type = PPTOOLTIP_NORMAL);
	HWND GetWndFromPoint(LPPOINT lpPoint, BOOL bUseDisabled = TRUE);
	LRESULT SendNotify(LPPOINT pt, PPTT_INFO & ti);
	...
	BOOL FindTool(HWND hWnd, const LPPOINT lpPoint, PPTT_INFO & ti);
	HWND FindTool(const LPPOINT lpPoint, PPTT_INFO & ti);
	HWND FindToolBarItem(POINT point, PPTT_INFO & ti);
