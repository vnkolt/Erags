...
#define IDEDIT		0x3E9
#define defaultEditStyle (ES_AUTOHSCROLL | ES_NOHIDESEL | ES_WANTRETURN | 0x200)
#define defaultListCtrlStyle (LVS_REPORT | LVS_SINGLESEL | LVS_SHOWSELALWAYS /*| LVS_NOCOLUMNHEADER*/ /*| LVS_SORTASCENDING*/)

#define defaultSizeDY 21
#define defaultSizeDX 16
...
public:
  ...
  int    m_EditID;  // by VK 25.05.2004 at 0:57:02
  int    m_ListID;  // by VK 25.05.2004 at 0:57:03
	class CWindowProcs
	{
	public:
		CWindowProcs()
...
// Attributes
public:
	bool  m_bBackspace, m_bDelete, m_bKeyPressed;

  PFNLVCOMPARE m_CompareFunc;

protected:
  BOOL  m_fEditOnChange;
// Operations
public:
  void  SetEditID(UINT ID) { m_EditID = ID; }
  void  SetListID(UINT ID) { m_ListID = ID; }
// Overrides
...
protected:
	...
	double m_dWidthList;
	virtual void SelectCurrentItem(BOOL fNotifyParent);
	int m_nColumnKey;
