...
Member function "ColorSortColumn" geändert (device context will be freed after
usage),
...
extern UINT res_IDB_HDRUP;
extern UINT res_IDB_HDRDOWN;
...
void CListBase::CreateSortIcons()
{
  if (!m_imglstSortIcons.m_hImageList)
  {
    ...
    m_imglstSortIcons.Create   (14, 13, ILC_COLOR24 | ILC_MASK, 2, 0);
    //m_bmpUpArrow.LoadMappedBitmap(res_IDB_HDRUP, 0, &cm, 1);
    m_bmpUpArrow.LoadBitmap(res_IDB_HDRUP);
    m_nUpArrow = m_imglstSortIcons.Add(&m_bmpUpArrow, RGB(255, 255, 255));
    //m_bmpDownArrow.LoadMappedBitmap(res_IDB_HDRDOWN, 0, &cm, 1);
    m_bmpDownArrow.LoadBitmap(res_IDB_HDRDOWN);
