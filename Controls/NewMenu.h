...
extern BOOL IsFocusChild(CWnd* pParentWnd);
/////////////////////////////////////////////////////////////////////////////
...
protected: 
  ...
  void DrawSmallBorder()
  {
    ...
    if ( ::GetMenu(m_hWnd) ) {
      ...
      GradientEraseBkgnd(pDC, rect, false);
      ReleaseDC(pDC);
    }
/************************************** : by VK at 23.05.2006 3:17:22 **\
    // To eliminate small border between menu and client rect
    MENUINFO menuInfo = {0};
...
public:
  ...
  void LoadDocString(UINT nIDResource);
};
...
void GradientEraseBkgnd(CWnd* pWnd, CWnd* pParent, CDC* pDC, CRect &rect, bool fCalcOffs=false);
void GradientEraseBkgnd(CDC* pDC, CRect &rect, bool fCalcOffs=true);
