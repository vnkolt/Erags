...
public:
    ...
    virtual void SetStrMask( LPCTSTR /* szMask */ )         { ASSERT( FALSE);    }
    ...
    virtual CString  GetStrMask() const                     { ASSERT( FALSE); return _T("");}
