...
public:
    ...
    void SetDBMode(BOOL bDBMode);
    BOOL GetDBMode() const                        { return m_bDBMode;                 }
    int  GetEditRow()                             { return m_EditRow;                 }
...
protected:
    ...
    BOOL        m_bVirtualMode;
    BOOL        m_bDBMode;  // by VK at 30.05.2004 19:06:32
    ...
    int         m_EditRow; // by VK at 30.05.2004 19:17:04
