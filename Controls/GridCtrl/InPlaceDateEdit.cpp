...
CInPlaceDateEdit::CInPlaceDateEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
                                   ...
                                   UINT nFirstChar)
{
    ...
    m_nColumn       = nColumn;
    m_nLastChar     = 0; 
    m_bExitOnArrows = TRUE; //(nFirstChar != VK_LBUTTON);    // If mouse click brought us here,
    ...
    switch (nFirstChar){
        ...
        /************************************** : by VK at 29.05.2004 9:09:39 **\
        default:          SetSel(0,-1);
        \************************************** : by VK at 29.05.2004 9:09:41 **/
    }
...
CInPlaceDateEdit::~CInPlaceDateEdit()
{
}

BEGIN_MESSAGE_MAP(CInPlaceDateEdit, CEraDateEdit)
...
////////////////////////////////////////////////////////////////////////////
// CInPlaceDateEdit message handlers

// If an arrow key (or associated) is pressed, then exit if
//  a) The Ctrl key was down, or
//  b) m_bExitOnArrows == TRUE
void CInPlaceDateEdit::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
    BOOL fExitArrows = FALSE;
...
/************************************** : by VK at 29.05.2004 9:14:53 **\
    if ((nChar == VK_PRIOR || nChar == VK_NEXT
        || nChar == VK_DOWN  || nChar == VK_UP   ||
        nChar == VK_RIGHT || nChar == VK_LEFT
        ) &&
        (fExitArrows || GetKeyState(VK_CONTROL) < 0))
    {
        m_nLastChar = nChar;
        GetParent()->SetFocus();
        return;
    }
\************************************** : by VK at 29.05.2004 9:15:00 **/    
    CEraDateEdit::OnKeyDown(nChar, nRepCnt, nFlags);
}

// As soon as this edit loses focus, kill it.
void CInPlaceDateEdit::OnKillFocus(CWnd* pNewWnd)
{
    CEraDateEdit::OnKillFocus(pNewWnd);
    EndEdit();
}

void CInPlaceDateEdit::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags) {
  ...
  CEraDateEdit::OnChar(nChar, nRepCnt, nFlags);
...
UINT CInPlaceDateEdit::OnGetDlgCode() 
{
...
BOOL CInPlaceDateEdit::PreTranslateMessage(MSG* pMsg) 
{
...
// Auto delete
void CInPlaceDateEdit::PostNcDestroy() 
{
    CEraDateEdit::PostNcDestroy();
