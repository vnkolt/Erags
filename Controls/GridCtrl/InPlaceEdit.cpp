                           ...
                           UINT nFirstChar)
{
    ...
    ((CGridCtrl*)pParent)->GetItem(&gvItem);
    m_strMask = gvItem.strMask;
...
/************************************** : by VK at 06.06.2004 12:08:49 **\
    if ( !m_strMask.IsEmpty() ) {
      SetLimitText( m_strMask.GetLength() );
    }
\************************************** : by VK at 06.06.2004 12:08:52 **/
