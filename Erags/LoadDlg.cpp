...
void CLoadDlg::LoadGeoTree() {
  SetWindowText("Завантажується список географічних назв. Зачекайте, будь ласка.");
  m_Progress.SetRange(0, 1000);
  theApp.m_bGeoLoaded = theGeoCache.Load(theDataManager.m_dbLists, &m_Progress, &m_Description);
}
void CLoadDlg::LoadRegistrars() {
  SetWindowText("Завантажується список органів реєстрації. Зачекайте, будь ласка.");
  m_Progress.SetRange(0, 1000);
  /*theApp.m_bRegLoaded = */theRList.Load(&m_Progress, &m_Description);
}
/////////////////////////////////////////////////////////////////////////////
