...
LPUNKNOWN Word::FontNames::Get_NewEnum()
{
	LPUNKNOWN result;
...
LPDISPATCH Word::FontNames::GetApplication()
{
	LPDISPATCH result;
	InvokeHelper(0x3e8, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
long Word::FontNames::GetCreator()
{
	long result;
	InvokeHelper(0x3e9, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
	return result;
...
LPDISPATCH Word::FontNames::GetParent()
{
	LPDISPATCH result;
	InvokeHelper(0x3ea, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
CString Word::FontNames::Item(long Index)
{
	CString result;
	static BYTE parms[] =
		VTS_I4;
